        ...
        >
          ...
          <li class="cart-list-con5">
            ...
            <input
              ...
              minnum="1"
              class="itxt"
              @change="changeNum('change', event.target.value, cart)"
            />
            <a
              href="javascript:void(0)"
              class="plus"
              @click="changeNum('add', -1, cart)"
              >+</a
            >
          </li>
    ...
    changeNum: throttle(async function (type, diff, cart) {
      switch (type) {
        case "add":
          ...
          break;
        case "sub":
          diff = cart.skuNum > 1 ? -1 : 0;
          break;
        case "change":
          if (isNan(diff) || diff < 1) {
            diff = 0;
          } else {
            diff = parseInt(diff) - cart.skuNum;
          }
          break;
      }
      try {
